...
function main(op)
	...
	local cStyle := cHtml:= cfooter:=''
		...
		USE ( PATH_DATA + 'movies.dbf' ) NEW SHARED
  	    INDEX ON field->nombre TAG "nombre" FOR field->tipo="AyS" .and. !Empty(field->ext) MEMORY			
	  ...
	  <div class="container">
        ...
        <div align="right"><a href="https://adhemarcr.github.io/acrsoft/"> <img
			src="https://acrsofts.github.io/moviecenter/images/hfw.jpg" align="right" width="80" height="80">
	  	   <h20><br>Powered By:<br>Adhemar Cuéllar ©2020</h20>
		  </div>
	  </div>
	ENDTEXT
retu nil
...
function Banner()
	...
	<div class="container">
		...
		<a href=todas.prg>
			...
			<center><b><h5>ACCION Y SUSPENSO</h5></b></center>
